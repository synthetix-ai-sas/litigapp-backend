...
namespace LitigApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260717171831_AddImportJobDuplicateCount")]
    partial class AddImportJobDuplicateCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LitigApp.Domain.Auth.LegalAcceptance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_legal_acceptances_user_id");

                    b.ToTable("legal_acceptances", (string)null);
                });

            modelBuilder.Entity("LitigApp.Domain.Auth.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("LitigApp.Domain.Auth.LegalAcceptance", b =>
                {
                    b.HasOne("LitigApp.Infrastructure.Identity.ApplicationUser", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_legal_acceptances_asp_net_users_user_id");
                });
